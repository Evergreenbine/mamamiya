...
//    数据统计方面
    ...
    @ResponseBody
    public List<Map> mostuse(HttpServletRequest req) {
        String stime = null;
        String etime = null;
        ...
        return konwlegeService.mostuse(stime,etime);
    }

    @GetMapping("/api/everylook")
    @ResponseBody
    public Map everlook(HttpServletRequest req) {
        String stime = null;
        String etime = null;
        ...
        map.put("stime",stime);
        map.put("etime",etime);
        return konwlegeService.everylook(map);
    }
